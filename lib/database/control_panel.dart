    ...
    return Column(
      ...
      children: [
        ...
        Row(
          ...
          children: [
            ElevatedButton(
              style: ElevatedButton.styleFrom(backgroundColor: availableColor),
              onPressed: () {
                addAcdemy(
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(backgroundColor: bookedColor),
              onPressed: () {
                removeAcdemy(
                    int.tryParse(yeasAcademy.text)!,
                    int.tryParse(monthAcademy.text)!,
                  ...
                  return AlertDialog(
                    content: Column(
                      ...
                      children: [
                        ...
                        const Text('Adding'),
                        Text('Month : ${AppCubit.get(context).monthDB}.....'),
